...
<script>
	...
	$(document).ready(function(){
		$("#submit_btn").click(function() {
			alert('등록되었습니다');
			$("#_frmForm").attr({"target":"_self", "action":"FreeSalewriteAf.do"}).submit();
...
<body>
<form id="_frmForm" method="post" action="FreeSalewriteAf.do">
	<img width="185" height="37"src="//image.hellomarket.com/web/tag/img_itemsubmit_title.png" />
	...
	<div class="box_price">
		<img src="//image.hellomarket.com/web/tag/img_itemsubmit_price.png" alt="판매가격" width="86" height="32"/>
